...
export default async (req) => {
  if (req.method !== "POST") return errorResponse("Method not allowed. POST a request with header x-seed-key.", 405);
  ...
  if (provided !== expected) return errorResponse("Invalid seed key.", 401);
